...
{
	c.SwaggerDoc("v1", new OpenApiInfo { Title = "EmployeeProjectManagement.API", Version = "v1" });
	...
	// Add security requirement to indicate that token is required
